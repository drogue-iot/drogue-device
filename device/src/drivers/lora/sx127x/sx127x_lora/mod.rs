    ...
    CS: OutputPin,
{
    ...
    pub fn initialize(&mut self) -> Result<(), Error<E, CS::Error>> {
    ...
    pub fn set_dio0_rx_done(&mut self) -> Result<(), Error<E, CS::Error>> {
    ...
    pub fn packet_ready(&mut self) -> Result<bool, Error<E, CS::Error>> {
        Ok(self.read_register(Register::RegIrqFlags.addr())?.get_bit(6))
    }

    pub fn irq_flags_mask(&mut self) -> Result<u8, Error<E, CS::Error>> {
        Ok(self.read_register(Register::RegIrqFlagsMask.addr())? as u8)
    }

    pub fn irq_flags(&mut self) -> Result<u8, Error<E, CS::Error>> {
        Ok(self.read_register(Register::RegIrqFlags.addr())? as u8)
    }

    pub fn read_packet_size(&mut self) -> Result<usize, Error<E, CS::Error>> {
    ...
    pub fn clear_irq(&mut self) -> Result<u8, Error<E, CS::Error>> {
    ...
    pub fn get_modem_stat(&mut self) -> Result<u8, Error<E, CS::Error>> {
    ...
    pub fn reset_payload_length(&mut self) -> Result<(), Error<E, CS::Error>> {
    ...
    pub fn set_frequency(&mut self, freq: u32) -> Result<(), Error<E, CS::Error>> {
    ...
    pub fn set_spreading_factor(&mut self, mut sf: u8) -> Result<(), Error<E, CS::Error>> {
        if sf < 6 {
            sf = 6;
        } else if sf > 12 {
            sf = 12;
    ...
    pub fn set_signal_bandwidth(&mut self, sbw: i64) -> Result<(), Error<E, CS::Error>> {
    ...
    /// Default value is `5`.
    pub fn set_coding_rate_4(&mut self, mut denominator: u8) -> Result<(), Error<E, CS::Error>> {
        if denominator < 5 {
            denominator = 5;
    ...
    /// Default value is `8`.
    pub fn set_preamble_length(&mut self, length: i64) -> Result<(), Error<E, CS::Error>> {
    ...
    fn write_register(&mut self, reg: u8, byte: u8) -> Result<(), Error<E, CS::Error>> {
        self.cs.set_low().map_err(CS)?;
    ...
    pub fn set_lora_pa_ramp(&mut self) -> Result<(), Error<E, CS::Error>> {
        self.write_register(Register::RegPaRamp as u8, 0b1000)
    }

    pub fn set_lora_sync_word(&mut self) -> Result<(), Error<E, CS::Error>> {
