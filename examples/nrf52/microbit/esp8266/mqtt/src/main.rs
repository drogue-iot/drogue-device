...
use nrf52833_pac::pwm3::events_pwmperiodend::R;
...
use drogue_device::domain::led;
use drogue_device::network::connection::NetworkError;
...
use drogue_device::network::connection::ConnectionFactory;
...
async fn main(spawner: embassy::executor::Spawner, p: Peripherals) {
    ...
    let mut client = MqttClient::<_, 5>::new(
...
static DNS: StaticDnsResolver<'static, 3> = StaticDnsResolver::new(&[
    ...
    DnsEntry::new("obabec.eu", IpAddress::new_v4(10, 200, 155, 38)),
]);
...
impl Actor for Receiver {
            ...
            M: Inbox<Self::Message<'m>> + 'm,
    {
            ...
            let mut client = MqttClient::<DrogueNetwork<Handle<'static, Esp8266Controller<'static, TX>>>, 5>::new(
