...
*** xref:examples/std/package/README.adoc[How to write a package containing multiple actors]
*** xref:examples/std/pingpong/README.adoc[Using circular dependencies between actors]
