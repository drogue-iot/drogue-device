...
[source,rust]
----
include::example$basic/src/main.rs[lines="26..36"]
----
...
[source,rust]
----
include::example$basic/src/main.rs[lines="44..50"]
----
...
----
include::example$basic/src/main.rs[lines="51..96"]
----
...
[source,rust]
----
include::example$basic/src/main.rs[lines="98..-1"]
----
